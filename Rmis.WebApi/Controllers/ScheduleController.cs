...
namespace Rmis.WebApi.Controllers
{
    ...
    public class ScheduleController : ControllerBase
    {
        ...
        [HttpGet("GetSchedulesByRoute")]
        public IActionResult GetSchedulesByRoute(int routeNumber, DateTimeOffset date)
        {
            try
            {
                return this.Ok(_scheduleService.GetSchedulesByRouteNumber(routeNumber, date));
            }
            catch (Exception e)
            {
                _logger.LogError(e, e.Message);
